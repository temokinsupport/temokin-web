                ...
                <Col>
                  <div className="--project-details">
                    <Image
                      className="d-block"
                      src={
                        require("../assets/images/propertyprojects/PropertyDev_IMG-NationalCamp.png")
                          .default
                      }
                      alt="First slide"
                    />
                    <div className="--about-content">
                      <Row>
                        ...
                        <Col md={6}>
                          <TextContainer>
                            <Label>Client</Label>
                            <Text>Ministry of Defence, Malaysia</Text>
                            <Label>Value</Label>
                            <Text>RM30 million</Text>
                            <Label>Period</Label>
                            <Text>Sept 2004 to Dec 2004</Text>
                          </TextContainer>
                        </Col>
                      </Row>
                      <Row>
