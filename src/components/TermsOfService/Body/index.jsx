    ...
    render() {
        ...
        return (
            <div className="--bg-2" data-scroll-section>
                ...
                <Row className="justify-content-center textBody">
                    <Col md={8}>
                    <div className="textBodyTitle" data-scroll>The use of this website is subject to the following terms of use:</div>

                    <div className="bodyContent">
                        The Content of the pages of this website is for your general information and use only, and we reserve the rights to change, vary or modify any of the information and terms contained herein without notice.
                    </div>
                    ...
                    <hr className="separator" />
                    <div className="bodyContent">
                        From time to time this website may also include links to other websites. These links are provided for your convenience to provide 
                        futher information. They do not signify that we 
