        ...
        <Row className="--header">
          <Col>
            ...
            <p className="--desc">
              ...
              REQUIREMENTS OF ISO 9001:2008, SPECIFICALLY FOR ROADWORKS AND
              INFRASTRUCTURE CONSTRUCTION, CERTIFIED BY SIRIM QAS INTERNATIONAL
              SDN BHD AND THE INTERNATIONAL CERTIFICATION NETWORK, IQNET.
            </p>
          </Col>
        </Row>
        <Row className="qas">
